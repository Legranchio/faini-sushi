...
<div class="panel panel-default">
  ...
  <div class="list-bordered">
	...
	<div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=kylshop">
			<div class="media-left"><img src="/templates/Fayni_s/img/sushi.svg" class="img-lg section_icon"></div>
			<div class="media-body">
				<h6 class="media-heading  text-semibold">Магазин</h6>
				<span class="text-muted text-size-small">Список замовлень і інше.</span>
			</div>
		</a>
	  </div>	
	  <div class="col-sm-6 media-list media-list-linked">
